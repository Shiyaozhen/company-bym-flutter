...
class BYCmdUtil {
  ...
  static String makeSendCMD(int cmdId, int pass, String content,
      {bool isHeartCmd = false}) {
  ...
  static String getMsgId(int cmdId,
      {bool isHeartCmd = false, String gunId = '0'}) {
  ...
  static void handleCPCmd(String cmd) {
    ...
    if (msgId == 113) {
      ...
      BLEManager().connectingDevice!.chargeGetData.controlEnableData =
          CPControlEnableData(content);
...
extension BYConvert on String {
  ...
  String get converttext_16 {
    String res = "";
    for (int i = 0; i < length; i++)
      res = res + codeUnitAt(i).toRadixString(16);
    return res;
  }
